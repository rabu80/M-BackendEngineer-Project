...
public class ItemController {
    ...
    public void updateItem(@PathVariable Long itemId,
                              @Valid @RequestBody ItemUpdateDto itemUpdateDto) throws Exception {
    ...
    public void deleteProduct(@PathVariable Long itemId) throws Exception {
    ...
    ItemDto getItemByItemId(@PathVariable Long itemId) {
